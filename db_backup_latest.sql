...
\restrict eOVTUgYchDh4M321l6Mq8ZXbcfTWc1ql44ZAd7ExIH0uXefHGbykbNBJkF7bqWb
...
ALTER TABLE IF EXISTS ONLY public."ReferenceForm" DROP CONSTRAINT IF EXISTS "ReferenceForm_applicationId_fkey";
...
ALTER TABLE IF EXISTS ONLY public."Certificate" DROP CONSTRAINT IF EXISTS "Certificate_programId_fkey";
...
DROP INDEX IF EXISTS public."User_createdAt_idx";
DROP INDEX IF EXISTS public."Submission_studentId_idx";
DROP INDEX IF EXISTS public."Submission_assignmentId_studentId_key";
DROP INDEX IF EXISTS public."Submission_assignmentId_idx";
DROP INDEX IF EXISTS public."Sponsorship_studentId_idx";
DROP INDEX IF EXISTS public."Sponsorship_stripePaymentId_key";
DROP INDEX IF EXISTS public."Sponsorship_courseId_idx";
DROP INDEX IF EXISTS public."Section_courseId_idx";
DROP INDEX IF EXISTS public."Rubric_courseId_idx";
DROP INDEX IF EXISTS public."RubricLevel_criteriaId_idx";
DROP INDEX IF EXISTS public."RubricCriteria_rubricId_idx";
DROP INDEX IF EXISTS public."Review_studentId_idx";
DROP INDEX IF EXISTS public."Review_courseId_studentId_key";
DROP INDEX IF EXISTS public."Review_courseId_idx";
DROP INDEX IF EXISTS public."ReferenceForm_applicationId_referenceIndex_key";
DROP INDEX IF EXISTS public."ReadingMaterial_sectionId_idx";
DROP INDEX IF EXISTS public."ReadingMaterialProgress_readingMaterialId_idx";
DROP INDEX IF EXISTS public."ReadingMaterialProgress_enrollmentId_readingMaterialId_key";
DROP INDEX IF EXISTS public."ReadingMaterialProgress_enrollmentId_idx";
DROP INDEX IF EXISTS public."Quiz_rubricId_idx";
DROP INDEX IF EXISTS public."Quiz_lessonId_key";
DROP INDEX IF EXISTS public."QuizAttempt_studentId_idx";
...
DROP INDEX IF EXISTS public."ProgramEnrollment_programId_idx";
DROP INDEX IF EXISTS public."ProgramApplication_reference2Token_key";
DROP INDEX IF EXISTS public."ProgramApplication_reference1Token_key";
...
DROP INDEX IF EXISTS public."Payment_courseId_idx";
...
DROP INDEX IF EXISTS public."Enrollment_status_idx";
DROP INDEX IF EXISTS public."Enrollment_sponsorshipId_idx";
DROP INDEX IF EXISTS public."Enrollment_paymentId_idx";
DROP INDEX IF EXISTS public."Enrollment_enrolledAt_idx";
DROP INDEX IF EXISTS public."Enrollment_courseId_idx";
DROP INDEX IF EXISTS public."EmailTemplate_name_key";
DROP INDEX IF EXISTS public."Discussion_sectionId_idx";
DROP INDEX IF EXISTS public."Discussion_lessonId_idx";
DROP INDEX IF EXISTS public."Discussion_courseId_idx";
DROP INDEX IF EXISTS public."Discussion_authorId_idx";
DROP INDEX IF EXISTS public."DiscussionReply_discussionId_idx";
DROP INDEX IF EXISTS public."DiscussionReply_authorId_idx";
...
DROP INDEX IF EXISTS public."Course_isFeatured_idx";
DROP INDEX IF EXISTS public."Course_instructorId_idx";
DROP INDEX IF EXISTS public."Course_categoryId_idx";
...
DROP INDEX IF EXISTS public."Coupon_courseId_idx";
DROP INDEX IF EXISTS public."Coupon_code_key";
DROP INDEX IF EXISTS public."Certificate_uniqueCode_key";
DROP INDEX IF EXISTS public."Certificate_templateId_idx";
DROP INDEX IF EXISTS public."Certificate_studentId_idx";
DROP INDEX IF EXISTS public."Certificate_programId_idx";
DROP INDEX IF EXISTS public."Certificate_courseId_idx";
DROP INDEX IF EXISTS public."Certificate_certificateNumber_key";
...
DROP INDEX IF EXISTS public."AttendanceSession_sectionId_idx";
DROP INDEX IF EXISTS public."AttendanceSession_courseId_idx";
DROP INDEX IF EXISTS public."AttendanceRecord_studentId_idx";
DROP INDEX IF EXISTS public."AttendanceRecord_sessionId_studentId_key";
DROP INDEX IF EXISTS public."Assignment_rubricId_idx";
DROP INDEX IF EXISTS public."Assignment_lessonId_key";
DROP INDEX IF EXISTS public."Answer_questionId_idx";
DROP INDEX IF EXISTS public."Announcement_sectionId_idx";
DROP INDEX IF EXISTS public."Announcement_courseId_idx";
DROP INDEX IF EXISTS public."Announcement_authorId_idx";
DROP INDEX IF EXISTS public."ActivityLog_userId_idx";
DROP INDEX IF EXISTS public."ActivityLog_status_idx";
DROP INDEX IF EXISTS public."ActivityLog_resource_idx";
...
ALTER TABLE IF EXISTS ONLY public."ReferenceForm" DROP CONSTRAINT IF EXISTS "ReferenceForm_pkey";
...
DROP TABLE IF EXISTS public."ReferenceForm";
...
--
-- Name: ReferenceForm; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Data for Name: ReferenceForm; Type: TABLE DATA; Schema: public; Owner: -
--
...
cmqp6pnjo000010tomoljdyc4	testing testing testing	joelrtharakan880@gmail.com	$2b$08$2Rac2Jh0DVdd62Iag9ynruvPyXuLBvaj7nlmiGIKgjeVv/5gZlh2K	STUDENT	\N	\N	+91 6360238632	\N	\N	ENGLISH	t	f	70	\N	\N	\N	\N	2026-06-22 12:21:19.86	2026-07-15 18:20:51.969	\N	\N	\N	\N	[]	{}	2026-07-15 16:46:51.824	2026-07-15 18:20:51.968	0
cmql8quqk0000h58xt3rfj7uo	Joel R Tharakan	joelrtharakan@gmail.com	$2b$08$whjJSZp22MdpdhZ/RuJdzuGZ.lTrCJvAG65HK.aZfHBOyQozbAJgC	INSTRUCTOR	https://pub-f282ad46200f49dc90b58a8a4e737923.r2.dev/avatars/1781892569411-cmql8quqk0000h58xt3rfj7uo.jpeg		+91 6360238632	Crossway AG Church	BENGALURU	ENGLISH	t	f	0	\N	\N	\N	\N	2026-06-19 18:07:10.364	2026-07-11 18:20:01.752	\N	Mr.	B.Tech	1	[]	{}	2026-07-11 18:19:55.752	2026-07-11 18:20:01.751	0
...
--
-- Name: ReferenceForm ReferenceForm_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: ActivityLog_resource_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: ActivityLog_status_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: Announcement_authorId_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: Announcement_sectionId_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: Assignment_rubricId_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: AttendanceRecord_studentId_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: AttendanceSession_courseId_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: AttendanceSession_sectionId_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: Certificate_programId_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: Certificate_studentId_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: Certificate_templateId_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: Coupon_courseId_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: Course_isFeatured_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: DiscussionReply_authorId_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: DiscussionReply_discussionId_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: Discussion_authorId_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: Discussion_courseId_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: Discussion_lessonId_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: Discussion_sectionId_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: Enrollment_enrolledAt_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: Enrollment_paymentId_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: Enrollment_sponsorshipId_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: Enrollment_status_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: LessonProgress_enrollmentId_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: LessonProgress_lessonId_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: Note_lessonId_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: Payment_courseId_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: ProgramApplication_reference1Token_key; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: ProgramApplication_reference2Token_key; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: ProgramEnrollment_programId_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: QuizAttempt_studentId_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: Quiz_rubricId_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: ReadingMaterialProgress_enrollmentId_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: ReadingMaterialProgress_readingMaterialId_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: ReadingMaterial_sectionId_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: ReferenceForm_applicationId_referenceIndex_key; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: Review_studentId_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: RubricCriteria_rubricId_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: RubricLevel_criteriaId_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: Rubric_courseId_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: Sponsorship_courseId_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: Sponsorship_studentId_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: Certificate Certificate_programId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: ReferenceForm ReferenceForm_applicationId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
\unrestrict eOVTUgYchDh4M321l6Mq8ZXbcfTWc1ql44ZAd7ExIH0uXefHGbykbNBJkF7bqWb
