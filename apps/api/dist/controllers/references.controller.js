...
exports.submitReference = exports.getReferenceByToken = void 0;
const client_1 = require("@prisma/client");
const errors_1 = require("../utils/errors");
const prisma = new client_1.PrismaClient();
// Get reference details by token
exports.getReferenceByToken = (0, errors_1.asyncHandler)(async (req, res) => {
...
exports.submitReference = (0, errors_1.asyncHandler)(async (req, res) => {
    const { token } = req.params;
