...
import { User, Lock, Bell, Camera, Check, Eye, EyeOff, MapPin, Phone, Church } from "lucide-react";
      ...
      <div key={activeTab} className="settings-section">
        ...
        {activeTab === "password" && (
          <SectionCard id="section-password">
            <SectionHeader icon={Lock} title={t("password.title")} description={t("password.subtitle")} />

            <form onSubmit={passwordForm.handleSubmit((d) => {
              if (d.newPassword !== d.confirmPassword) {
                passwordForm.setError("confirmPassword", { message: t("messages.passwordsMismatch") });
                return;
              }
              ...
              <div style={{ marginBottom: 20, position: "relative" }}>
                <SettingsInput
                  ...
                  icon={Lock}
                  {...passwordForm.register("currentPassword", { required: t("password.required") })}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5 mb-5">
                <div style={{ position: "relative" }}>
                  <SettingsInput
                    ...
                    {...passwordForm.register("newPassword", {
                      ...
                      minLength: { value: 8, message: t("password.minChars") },
                    })}
                ...
                <div style={{ position: "relative" }}>
                  <SettingsInput
                    ...
                    icon={Lock}
                    {...passwordForm.register("confirmPassword", { required: t("password.required") })}
        ...
        {activeTab === "notifications" && (
          <SectionCard id="section-notifications">
            <SectionHeader icon={Bell} title={t("notifications.title")} description={t("notifications.subtitle")} />

            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              {[
                { key: "email_announcements" as const, label: t("notifications.announcements"), desc: t("notifications.announcementsDesc") },
                { key: "email_grades" as const, label: t("notifications.grades"), desc: t("notifications.gradesDesc") },
                { key: "email_certificates" as const, label: t("notifications.certificates"), desc: t("notifications.certificatesDesc") },
                { key: "email_message" as const, label: t("notifications.messages"), desc: t("notifications.messagesDesc") },
              ].map((n) => (
                <div
                  key={n.key}
                  style={{
