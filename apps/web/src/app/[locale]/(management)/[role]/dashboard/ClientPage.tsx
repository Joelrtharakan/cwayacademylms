    ...
    <div style={{ maxWidth: "1400px" }}>
        ...
        <div style={{ display: "flex", gap: "16px", flexWrap: "wrap", marginBottom: "32px" }}>
          {(stats?.pendingApprovals ?? 0) > 0 && (
            ...
            >
              ...
              <div>
                <h3 style={{ fontSize: "15px", fontWeight: 700, color: "#1A261D", margin: 0 }}>{t("pendingCourses", { count: stats?.pendingApprovals })}</h3>
                <p style={{ fontSize: "13px", color: "#8F9E93", margin: "2px 0 0 0" }}>{t("pendingCoursesDesc")}</p>
              </div>
            </div>
          )}
          {pendingAppsCount > 0 && (
            ...
            >
              ...
              <div>
                <h3 style={{ fontSize: "15px", fontWeight: 700, color: "#1A261D", margin: 0 }}>{t("pendingApps", { count: pendingAppsCount })}</h3>
                <p style={{ fontSize: "13px", color: "#8F9E93", margin: "2px 0 0 0" }}>{t("pendingAppsDesc")}</p>
              </div>
            </div>
          )}
        </div>
      ...
      {!statsLoading && stats?.pendingApprovals > 0 && (
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
            ...
            <div>
              <p style={{ fontSize: "14px", fontWeight: 600, color: "#1A261D", margin: 0 }}>
                {t("pendingApprovalsBanner", { count: stats.pendingApprovals })}
              </p>
          ...
          >
            {t("reviewNow")} <ArrowRight size={13} />
          </button>
        </div>
      )}
      ...
      <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr", gap: "24px", marginBottom: "32px", alignItems: "stretch" }}>
        ...
        <div style={{ borderRadius: "16px", background: "#FFFFFF", border: "1px solid #E4E8E0", boxShadow: "0 1px 3px rgba(26,38,29,0.04)", padding: "28px", display: "flex", flexDirection: "column" }}>
          <div style={{ marginBottom: "24px" }}>
            <h2 style={{ fontFamily: "Georgia, serif", fontSize: "18px", fontWeight: 700, color: "#1A261D", margin: 0 }}>{t("categoryDistribution")}</h2>
            <p style={{ fontSize: "13px", fontWeight: 500, color: "#8F9E93", margin: "4px 0 0 0" }}>{t("coursesPerCategory")}</p>
          </div>
          {coursesLoading ? (
            ...
            <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: "12px", borderRadius: "12px", background: "#F7F8F5", border: "1px dashed #DCE0D5" }}>
              <p style={{ fontSize: "14px", fontWeight: 500, color: "#8F9E93", margin: 0 }}>{t("noCategories")}</p>
            </div>
          ) : (
                      ...
                      content={({ active, payload }: any) => {
                        ...
                        return (
                          <div style={{ background: "#1A261D", border: "1px solid rgba(255,255,255,0.1)", borderRadius: "8px", padding: "8px 12px", color: "#FFFFFF", fontSize: "12px", boxShadow: "0 4px 12px rgba(0,0,0,0.1)" }}>
                            <span style={{ fontWeight: 600 }}>{data.categoryName}</span>: {t("coursesCount", { count: data.courseCount })}
                          </div>
                        );
                      }}
                    />
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(min(100%, 400px), 1fr))", gap: "24px" }}>
        ...
        <div style={{ borderRadius: "16px", background: "#FFFFFF", border: "1px solid #E4E8E0", boxShadow: "0 1px 3px rgba(26,38,29,0.04)", padding: "28px" }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "24px" }}>
            <div>
              <h2 style={{ fontFamily: "Georgia, serif", fontSize: "18px", fontWeight: 700, color: "#1A261D", margin: 0 }}>{t("completionRates")}</h2>
              <p style={{ fontSize: "13px", fontWeight: 500, color: "#8F9E93", margin: "4px 0 0 0" }}>{t("highestCompletion")}</p>
            </div>
          ...
          {coursesLoading ? (
            ...
            <div style={{ height: "160px", display: "flex", alignItems: "center", justifyContent: "center", borderRadius: "12px", background: "#F7F8F5", border: "1px dashed #DCE0D5" }}>
              <p style={{ fontSize: "14px", fontWeight: 500, color: "#8F9E93", margin: 0 }}>{t("noCompletionData")}</p>
            </div>
          ) : (
            <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
        ...
        <div style={{ borderRadius: "16px", background: "#FFFFFF", border: "1px solid #E4E8E0", boxShadow: "0 1px 3px rgba(26,38,29,0.04)", padding: "28px" }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "24px" }}>
            <div>
              <h2 style={{ fontFamily: "Georgia, serif", fontSize: "18px", fontWeight: 700, color: "#1A261D", margin: 0 }}>{t("topRatedCourses")}</h2>
              <p style={{ fontSize: "13px", fontWeight: 500, color: "#8F9E93", margin: "4px 0 0 0" }}>{t("highestAverageReviews")}</p>
            </div>
          ...
          {coursesLoading ? (
            ...
            <div style={{ height: "160px", display: "flex", alignItems: "center", justifyContent: "center", borderRadius: "12px", background: "#F7F8F5", border: "1px dashed #DCE0D5" }}>
              <p style={{ fontSize: "14px", fontWeight: 500, color: "#8F9E93", margin: 0 }}>{t("noRatingsYet")}</p>
            </div>
          ) : (
            <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
              {topRatedCourses.map((course: any, i: number) => (
                <div key={course.id} style={{ display: "flex", alignItems: "center", gap: "12px", padding: "12px", borderRadius: "12px", background: "#FAFAFA", border: "1px solid #F7F8F5" }}>
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    <span style={{ display: "block", fontSize: "12px", color: "#8F9E93", marginTop: "2px" }}>{course.reviewCount} {t("reviews")}</span>
                  </div>
        ...
        >
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "24px" }}>
            ...
            >
              {t("manageAll")} <ArrowRight size={12} />
            </button>
          </div>
