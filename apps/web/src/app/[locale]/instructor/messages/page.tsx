    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ padding: "20px 20px 16px" }}>
          <h2 style={{ fontFamily: "Georgia, serif", fontSize: 20, fontWeight: 800, color: DARK, marginBottom: 14, letterSpacing: "-0.01em" }}>{t("title")}</h2>
          <div style={{ display: "flex", alignItems: "center", gap: 8, background: "#FFFFFF", borderRadius: 10, padding: "10px 14px", border: "1px solid #E4E8E0" }}>
            ...
            <input value={search} onChange={e => setSearch(e.target.value)} placeholder={t("searchPlaceholder")} style={{ background: "transparent", border: "none", outline: "none", color: DARK, fontSize: 14, width: "100%" }} />
          </div>
        </div>
      ...
      {selectedUser ? (
        ...
        <div style={{ flex: 1, alignItems: "center", justifyContent: "center", flexDirection: "column", gap: 12, padding: 32 }} className="hidden md:flex">
          ...
          <p style={{ color: MUTED, fontSize: 14, fontWeight: 700 }}>{t("selectPrompt")}</p>
        </div>
      )}
    </div>
  );
