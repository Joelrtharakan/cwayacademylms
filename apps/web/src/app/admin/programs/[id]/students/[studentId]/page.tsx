  ...
  if (error || !data) {
    return (
      <div style={{ textAlign: "center", padding: "80px 40px" }}>
        ...
        <Link href={`/admin/programs/${id}`} style={{ color: "#C9973A" }}>← Back to Program</Link>
      </div>
    );
  }
