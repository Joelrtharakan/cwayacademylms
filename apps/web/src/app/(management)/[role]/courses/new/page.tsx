        ...
        <div style={{ padding: "40px" }}>
          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "32px" }}>
            ...
            <div style={{ paddingTop: "16px", borderTop: "1px solid rgba(184,134,69,0.15)", display: "flex", justifyContent: "flex-end", gap: "16px" }}>
              <Link href={`${basePath}/courses`} style={{ padding: "14px 28px", borderRadius: "999px", fontSize: "15px", fontWeight: 600, color: "#8F9E93", textDecoration: "none", display: "flex", alignItems: "center" }}>
                Cancel
              </Link>
              <button
                type="submit"
