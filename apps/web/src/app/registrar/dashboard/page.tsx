...
import { StatCard } from "@/components/registrar/StatCard";
import { PageHeader } from "@/components/registrar/PageHeader";
import { getAdminStats, getRevenueAnalytics, getCourseAnalytics, getUsers } from "@/lib/api/registrar";
    ...
    <div style={{ maxWidth: "1400px" }}>
      ...
      {!statsLoading && stats?.pendingApprovals > 0 && (
        ...
        >
          ...
          <button
            onClick={() => router.push("/registrar/courses?status=PENDING")}
            style={{
              display: "flex",
              alignItems: "center",
              gap: "8px",
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(min(100%, 400px), 1fr))", gap: "24px" }}>
        ...
        >
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "24px" }}>
            ...
            <button
              onClick={() => router.push("/registrar/courses")}
              style={{
                display: "flex",
                alignItems: "center",
                gap: "6px",
