...
const NAV: NavSection[] = [
  {
    title: "Overview",
    items: [{ name: "Dashboard", href: "/registrar/dashboard", icon: LayoutDashboard }],
  },
  {
    title: "People",
    items: [
      { name: "Users", href: "/registrar/users", icon: Users },
      { name: "Instructors", href: "/registrar/instructors", icon: GraduationCap },
      { name: "Messages", href: "/registrar/messages", icon: MessageSquare },
    ],
  },
  {
    title: "Content",
    items: [
      { name: "Programs", href: "/registrar/programs", icon: LayoutTemplate },
      { name: "Applications", href: "/registrar/applications", icon: FileText },
      { name: "Courses", href: "/registrar/courses", icon: BookOpen },
      { name: "Categories", href: "/registrar/categories", icon: FolderKanban },
      { name: "Blog Posts", href: "/registrar/blog", icon: FileText },
    ],
  },
  {
    title: "Business",
    items: [
      { name: "Payments", href: "/registrar/payments", icon: CreditCard },
      { name: "Sponsorships", href: "/registrar/sponsorships", icon: HeartHandshake },
      { name: "Coupons", href: "/registrar/coupons", icon: Percent },
    ],
  },
  {
    title: "Analytics",
    items: [{ name: "Reports", href: "/registrar/analytics", icon: BarChart3 }],
  },
  {
    title: "System",
    items: [
      { name: "Certificates", href: "/registrar/certificates", icon: Award },
      { name: "Email Templates", href: "/registrar/emails", icon: Mail },
      { name: "Notifications", href: "/registrar/notifications", icon: Bell },
      { name: "Activity Logs", href: "/registrar/logs", icon: Activity },
      { name: "Settings", href: "/registrar/settings", icon: Settings },
    ],
  },
];
...
export default function RegistrarSidebar({ mobileOpen = false, onClose = () => {}, collapsed = false, onToggleCollapse = () => {} }: { mobileOpen?: boolean, onClose?: () => void, collapsed?: boolean, onToggleCollapse?: () => void }) {
