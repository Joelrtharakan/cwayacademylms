...
import { getAdminStats, getRevenueAnalytics, getUserAnalytics, getEnrollmentAnalytics, getCourseAnalytics, getUsers, getStudentTimeAnalytics } from "@/lib/api/registrar";
