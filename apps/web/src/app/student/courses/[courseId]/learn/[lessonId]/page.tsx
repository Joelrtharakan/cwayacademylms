  ...
  return (
    <div className="w-full h-full flex flex-col relative">
      <div className="flex-1 overflow-y-auto custom-scrollbar relative">
        {/* VIDEO LESSON */}
        {lesson.type === "VIDEO" && (
          <div className="flex flex-col h-full bg-[#1C2B1E]">
            ...
            <div className="max-w-4xl w-full mx-auto p-6 md:p-10 text-[#F5F0E8]">
              ...
              <div className="mt-8 pt-8 border-t border-[rgba(201,151,58,0.2)]">
                {lesson.isCompleted ? (
                  ...
                  <button 
                    ...
                    className="px-6 py-3 bg-[#C9973A] text-[#1C2B1E] rounded-lg font-bold flex items-center gap-2 hover:bg-[#A8792A] transition-colors"
                  >
        ...
        {/* TEXT LESSON */}
        {lesson.type === "TEXT" && (
          <div className="w-full min-h-full bg-[#F5F0E8] text-[#1C2B1E]">
            <div className="max-w-3xl mx-auto py-12 px-6 md:py-16 md:px-12">
              ...
              <h1 className="font-serif text-4xl md:text-5xl font-bold mb-6 text-[#1C2B1E]">
                {lesson.title}
              </h1>
              <div className="w-20 h-1 bg-[#C9973A] mb-10"></div>
              
              <div className="prose prose-lg max-w-none prose-headings:font-serif prose-headings:text-[#1C2B1E] prose-p:text-[#1C2B1E]/80 prose-p:leading-relaxed prose-a:text-[#C9973A] prose-blockquote:border-l-[#C9973A] prose-blockquote:bg-[rgba(201,151,58,0.06)] prose-blockquote:py-4 prose-blockquote:pr-4 prose-blockquote:rounded-r-lg prose-blockquote:font-serif prose-blockquote:italic prose-blockquote:text-lg" 
                   dangerouslySetInnerHTML={{ __html: lesson.content || "" }} />

              <div className="mt-16 pt-8 border-t border-[rgba(28,43,30,0.1)]">
                {lesson.isCompleted ? (
                  ...
                  <button 
                    onClick={markComplete}
                    className="w-full md:w-auto px-8 py-4 bg-[#C9973A] text-[#1C2B1E] rounded-lg font-bold flex justify-center items-center gap-2 hover:bg-[#A8792A] transition-colors"
                  >
                    Mark as Complete <CheckCircle className="w-5 h-5" />
                  </button>
                )}
        ...
        {lesson.type === "QUIZ" && (
          <div className="max-w-3xl w-full mx-auto p-6 md:py-12">
            ...
            {quizState === "not_started" && (
              <div className="bg-[#243825] border border-[rgba(201,151,58,0.2)] rounded-2xl p-8 md:p-12 text-center relative overflow-hidden">
                ...
                <h1 className="font-serif text-3xl md:text-4xl text-[#F5F0E8] font-bold mb-4">{lesson.title}</h1>
                <div className="flex flex-wrap justify-center gap-4 text-sm text-[#8A9E8C] mb-8">
                  <span className="bg-[#1C2B1E] px-3 py-1 rounded-full border border-[rgba(201,151,58,0.15)]">
                ...
                {lesson.attempts && lesson.attempts.length > 0 && (
                  <div className="mb-8 text-left bg-[#1C2B1E] rounded-xl p-4 border border-[rgba(201,151,58,0.1)]">
                    <h3 className="text-sm font-semibold text-[#F5F0E8] mb-3 uppercase tracking-wider">Previous Attempts</h3>
                    <div className="space-y-2">
                      {lesson.attempts.map((att: any, i: number) => (
                        <div key={att.id} className="flex justify-between items-center text-sm p-2 rounded bg-[rgba(255,255,255,0.02)]">
                ...
                <button 
                  onClick={startQuiz}
                  className="px-8 py-4 bg-[#C9973A] text-[#1C2B1E] rounded-full font-bold uppercase tracking-wider hover:bg-[#A8792A] transition-colors"
                >
                  Start Quiz
                </button>
              </div>
              ...
              <div>
                <div className="mb-6 flex items-center justify-between">
                  <div className="text-sm text-[#8A9E8C]">
                    Question <span className="text-[#F5F0E8] font-bold">{currentQuestionIdx + 1}</span> of {quizData.quiz.questions.length}
                  </div>
                  <div className="w-1/2 h-1.5 bg-[#243825] rounded-full overflow-hidden">
                    <div className="h-full bg-[#C9973A] transition-all" style={{ width: `${((currentQuestionIdx + 1) / quizData.quiz.questions.length) * 100}%` }} />
                  </div>
                </div>

                <div className="bg-[#243825] border border-[rgba(201,151,58,0.2)] rounded-2xl p-6 md:p-10 shadow-xl">
                  {(() => {
                    ...
                    return (
                      <div>
                        <div className="flex justify-between items-start mb-6">
                          ...
                          <div className="text-xs bg-[#1C2B1E] text-[#8A9E8C] px-2 py-1 rounded border border-[rgba(201,151,58,0.15)]">
                        ...
                        <h2 className="text-xl md:text-2xl text-[#F5F0E8] leading-relaxed mb-8">{q.text}</h2>
                              ...
                              return (
                                <button
                                  ...
                                  className={`w-full text-left p-4 rounded-xl border transition-all flex items-center gap-4
                                    ${isSelected ? 'bg-[rgba(201,151,58,0.1)] border-[#C9973A]' : 'bg-[rgba(255,255,255,0.02)] border-[rgba(201,151,58,0.2)] hover:border-[rgba(201,151,58,0.4)] hover:bg-[rgba(201,151,58,0.05)]'}
                                  `}
                                >
                                  <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center shrink-0 ${isSelected ? 'border-[#C9973A] bg-[#C9973A]' : 'border-[rgba(201,151,58,0.4)]'}`}>
                                    {isSelected && <div className="w-2 h-2 rounded-full bg-[#1C2B1E]" />}
                                  </div>
                                  <span className={`text-[15px] ${isSelected ? 'text-[#C9973A] font-semibold' : 'text-[#F5F0E8]'}`}>{ans.text}</span>
                                </button>
                              );
                            })}
                          </div>
                        ...
                        {q.type === "SHORT_ANSWER" && (
                          <div>
                            <textarea
                              ...
                              rows={5}
                              className="w-full bg-[#1C2B1E] border border-[rgba(201,151,58,0.3)] rounded-xl p-4 text-[#F5F0E8] placeholder-[#8A9E8C] focus:outline-none focus:border-[#C9973A] transition-colors"
                  ...
                  <div className="mt-10 pt-6 border-t border-[rgba(201,151,58,0.1)] flex justify-between">
                    <button
                      onClick={() => setCurrentQuestionIdx(i => Math.max(0, i - 1))}
                      disabled={currentQuestionIdx === 0}
                      className="px-4 py-2 text-[#8A9E8C] hover:text-[#F5F0E8] disabled:opacity-30 transition-colors flex items-center gap-1 text-sm font-semibold"
                    >
                    ...
                    {currentQuestionIdx === quizData.quiz.questions.length - 1 ? (
                      <button
                        onClick={submitQuiz}
                        className="px-6 py-2 bg-[#C9973A] text-[#1C2B1E] rounded-lg font-bold hover:bg-[#A8792A] transition-colors"
                      >
                        Submit Quiz
                      </button>
                    ) : (
                      <button
                        ...
                        className="px-6 py-2 bg-[#C9973A] text-[#1C2B1E] rounded-lg font-bold hover:bg-[#A8792A] transition-colors flex items-center gap-1"
                      >
            ...
            {quizState === "results" && quizResult && (
              <div className="space-y-8">
                <div className="bg-[#243825] border border-[rgba(201,151,58,0.2)] rounded-2xl p-10 text-center shadow-xl">
                  {quizResult.passed ? (
                  ...
                  <div className="w-40 h-40 mx-auto rounded-full border-8 flex items-center justify-center relative mb-6" style={{ borderColor: quizResult.passed ? '#4A8C5C' : '#8C3A3A' }}>
                    <div className="text-center">
                      <div className="font-serif text-4xl text-[#F5F0E8] font-bold">{quizResult.score.toFixed(0)}%</div>
                    </div>
                  </div>
                  ...
                  <p className="text-[#8A9E8C] mb-6">
                    ...
                    <br/>
                    Points earned: <span className="text-[#F5F0E8] font-semibold">{quizResult.earnedPoints}</span> out of <span className="text-[#F5F0E8] font-semibold">{quizResult.totalPoints}</span>
                  </p>
                  ...
                  <div className="flex justify-center gap-4">
                    {quizResult.passed ? (
                      ...
                      <button 
                        onClick={startQuiz}
                        className="px-6 py-3 border border-[#C9973A] text-[#C9973A] rounded-lg font-bold hover:bg-[#C9973A] hover:text-[#1C2B1E] transition-colors"
                      >
                ...
                <div className="space-y-4">
                  <h3 className="font-serif text-2xl text-[#F5F0E8] mb-4">Review Answers</h3>
                  {quizResult.results.map((r: any, i: number) => (
                    <div key={i} className="bg-[#243825] border border-[rgba(201,151,58,0.15)] rounded-xl p-6">
                      <div className="flex justify-between items-start mb-3">
                        <div className="text-sm font-semibold text-[#8A9E8C]">Question {i + 1}</div>
                        <div className="text-xs bg-[#1C2B1E] px-2 py-1 rounded text-[#8A9E8C] border border-[rgba(201,151,58,0.1)]">
                          {r.pointsEarned} / {r.points} pts
                        </div>
                      </div>
                      <div className="text-[#F5F0E8] text-lg mb-4">{r.questionText}</div>
        ...
        {lesson.type === "ASSIGNMENT" && (
          <div className="w-full min-h-full bg-[#F5F0E8] text-[#1C2B1E] px-6 py-12 md:py-16">
            <div className="max-w-3xl mx-auto space-y-8">
              
              <div className="bg-white border border-[rgba(28,43,30,0.08)] rounded-2xl p-8 md:p-10 shadow-sm">
                ...
                <h1 className="font-serif text-3xl md:text-4xl text-[#1C2B1E] font-bold mb-4">{lesson.assignment?.title}</h1>
                <div className="flex flex-wrap gap-4 text-sm text-[#8A9E8C] mb-8 pb-8 border-b border-[rgba(28,43,30,0.05)]">
                  ...
                  <span className="bg-[#1C2B1E]/5 px-2 py-0.5 rounded font-medium text-[#1C2B1E]">
                    Max Score: {lesson.assignment?.maxScore} pts
                  </span>
                </div>

                <div className="prose prose-sm max-w-none text-[#1C2B1E]/80" dangerouslySetInnerHTML={{ __html: lesson.assignment?.description || "" }} />
              ...
              {!assignmentSub && (
                <div className="bg-white border border-[rgba(28,43,30,0.08)] rounded-2xl p-8 md:p-10 shadow-sm">
                  ...
                  <div className="space-y-6">
                    <div>
                      <label className="block text-sm font-semibold text-[#1C2B1E] mb-2">Response</label>
                      <textarea 
                        rows={6}
                        className="w-full bg-[#F5F0E8]/50 border border-[rgba(28,43,30,0.1)] rounded-xl p-4 focus:outline-none focus:border-[#C9973A] focus:ring-1 focus:ring-[#C9973A] transition-all placeholder:text-[#8A9E8C]"
                        placeholder="Write your response here..."
                      />
                    </div>
                    <div>
                      <label className="block text-sm font-semibold text-[#1C2B1E] mb-2">Upload File (Optional)</label>
                      <div className="border-2 border-dashed border-[rgba(28,43,30,0.15)] rounded-xl p-8 text-center hover:border-[#C9973A] transition-colors cursor-pointer bg-[#F5F0E8]/30">
                        <div className="text-[#A8792A] mb-2">↑</div>
                        <div className="text-sm font-semibold text-[#1C2B1E]">Click to upload or drag and drop</div>
                        <div className="text-xs text-[#8A9E8C] mt-1">PDF, DOC, ZIP up to 50MB</div>
                      </div>
                    </div>
                    <button className="w-full md:w-auto px-8 py-4 bg-[#C9973A] text-[#1C2B1E] rounded-lg font-bold shadow-lg shadow-[#C9973A]/20 hover:bg-[#A8792A] transition-colors">
                      Submit Assignment
                    </button>
                  </div>
                </div>
              ...
              {assignmentSub && !assignmentSub.isGraded && (
                <div className="bg-white border-l-4 border-l-[#4A8C5C] rounded-2xl p-8 shadow-sm flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-serif text-xl font-bold text-[#1C2B1E] mb-2">Assignment Submitted!</h3>
              ...
              {assignmentSub && assignmentSub.isGraded && (
                <div className="bg-white border border-[rgba(28,43,30,0.08)] rounded-2xl overflow-hidden shadow-sm">
                  <div className="bg-[#1C2B1E] p-6 text-center text-[#F5F0E8] relative">
                  ...
                  {assignmentSub.feedback && (
                    <div className="p-8">
                      <div className="bg-[#C9973A]/5 border-l-4 border-[#C9973A] p-6 rounded-r-lg">
                        <h4 className="font-serif text-lg font-bold text-[#1C2B1E] mb-2">Instructor Feedback</h4>
                        <div className="text-sm text-[#1C2B1E]/80 leading-relaxed" dangerouslySetInnerHTML={{ __html: assignmentSub.feedback }} />
                      </div>
                    </div>
                  )}
                  <div className="p-6 bg-[#F5F0E8]/50 border-t border-[rgba(28,43,30,0.05)] text-center">
                    <button className="px-6 py-3 bg-[#4A8C5C] text-white rounded-lg font-bold">
                      Continue to Next Lesson &rarr;
                    </button>
                  </div>
      ...
      <div className="h-16 shrink-0 bg-[#243825] border-t border-[rgba(201,151,58,0.2)] flex items-center justify-between px-4 md:px-8 z-30">
        ...
        <button className="px-4 py-2 bg-transparent border border-[#C9973A] text-[#C9973A] hover:bg-[#C9973A] hover:text-[#1C2B1E] rounded-md text-sm font-semibold transition-colors flex items-center gap-2">
