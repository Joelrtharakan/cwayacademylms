    ...
    <div style={{ background: "#FFFFFF", borderRadius: "16px", padding: "32px", boxShadow: "0 4px 12px #E4E8E0" }}>
      ...
      {isAdding ? (
        <form onSubmit={handleCreate} style={{ marginTop: "24px", padding: "24px", background: "#F8FAFC", borderRadius: "12px", border: "1px solid #E2E8F0" }}>
          ...
          <textarea placeholder="Brief description (optional)" value={description} onChange={(e) => setDescription(e.target.value)} rows={3} data-lenis-prevent="true" style={{ width: "100%", padding: "12px", borderRadius: "8px", border: "1px solid #E2E8F0", marginBottom: "16px", resize: "vertical", overflowY: "auto", minHeight: "120px", maxHeight: "300px" }} />
